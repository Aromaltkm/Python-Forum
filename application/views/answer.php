                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            <div class="stnt pull-left col-md-6">                            
                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            <div class="stnt pull-left col-md-6">                            
                                    ...
                                    <button class="btn btn-primary" id="togglereply">Reply</button>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            ...
                            <div class="post beforepagination">
                                ...
                                <div class="postinfobot">
                                    ...
                                    <div class="likeblock pull-left">
                                        <a href="#" class="up"><i class="fa fa-thumbs-o-up"></i><span id="likescount"><?php  echo $value->like_count;?></span> </a>
                                        <!-- <a href="#" class="down"><i class="fa fa-thumbs-o-down"></i>3</a> -->
                                    </div>

                                    <div class="prev pull-left">                                        
                                        <a href="#" id="#togglereply"><i class="fa fa-reply"></i></a>
                                    </div>

                                    <div class="posted pull-right"><i class="fa fa-clock-o"></i> Posted on : <?php  echo $value->submission_date; ?></div>
                            ...
                            <?php }	?>
                            <br>
                            <div class="post beforepagination" id="replyform" hidden>
                                <div class="topwrap">
                                    <div class="userinfo pull-left">
                                        <div class="avatar">
                                            <img src="<?php echo base_url();?>assets/images/avatar2.jpg" alt="" />
                                    ...
                                    <form method="POST">
                                    <div class="posttext pull-left">
                                        <textarea name="desc" placeholder="Your reply here...." class="form-control" rows=4 id="description" required></textarea>
                                    </div>
                                    <div class="posted pull-right"></div>
                                    <center>
                                    <div class="next" >                                        
                            ...
                            <div class="post">
                                ...
                                <div class="wrap-ut pull-left">
                                    ...
                                    <div class="posttext pull-left">
                                        <h6><a href="http://forum.azyrusthemes.com/02_topic.html"><?php  echo $value->username; ?></a></h6>
...
<!--                                     <div class="comments">
                                    ...
                                    <div class="views"><a href="#" class="answerup" id="<?php echo $value->id; ?>"><i class="fa fa-thumbs-o-up"></i><span id="answerlikescount"><?php  echo $value->like_count;?></span> </a></div>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
                ...
                $('#replybtn').click(function(event){
                    ...
                    arr=<?php echo json_encode($question); ?>;
                    questionId=arr[0]['id']
                    desc=$('#description').val();
                    $.ajax({
                        type :"POST",
                        url :"<?php echo base_url();?>index.php/forum/postanswer",
                        data : {question_id:questionId,description:desc},
                        dataType : 'json',
                        success : function(response){
                            if(response.status=="success"){
                                $('#description').val('');
                                $('body').load("<?php echo base_url(); ?>index.php/forum/answer/"+questionId)
                                // alert("Successfully submitted the answer...");
                            }else{
                ...
                // });
                $('#home').click(function(){
                    $('body').load("<?php echo base_url(); ?>index.php/forum/home");
                });
                ...
                $('.up').click(function(event){
                    ...
                    $.ajax({
                        type : "POST",
                        url : "<?php echo base_url() ?>index.php/forum/like",
                        dataType : "json",
                ...
                $('.answerup').click(function(event){
                    event.preventDefault();
                    id=$(this).attr('id');
                    tag=$("#"+id).children('#answerlikescount');
                    val=tag.text();
                    // alert(val);
                    $.ajax({
                        type : "POST",
                        url : "<?php echo base_url() ?>index.php/forum/answerlike",
                        dataType : "json",
                        data : {id:id},
                        success : function(response){
                            if(response.status=="success"){
